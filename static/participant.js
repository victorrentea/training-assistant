...
let myWords = [];  // participant's own submitted words (persisted in localStorage per word cloud session)
  ...
  // WC_COLORS is in shared-utils.js
  let _wcDebounceTimer = null;
  let _lastPaxWcWordsJson = null;
  ...
  function renderWordCloud(words) {
    ...
    if (wordsJson !== _lastPaxWcWordsJson) {
      _lastPaxWcWordsJson = wordsJson;
  ...
  // escDebate(), DEBATE_PHASES, getDebateSubPhases() are in shared-utils.js
  ...
  // _playDebateChime() is in shared-utils.js
  ...
  // renderDebatePhaseStepper() is in shared-utils.js
