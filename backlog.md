...
- [ ] The message displayed by the daemon into the host user interface should be a bit more specific. In particular, distinguishing the remote status code if it's 500 or 50029, explain in a brief line what is the cause of the error. 
