...
- [x] The message displayed by the daemon into the host user interface should be a bit more specific. In particular, distinguishing the remote status code if it's 500 or 50029, explain in a brief line what is the cause of the error.
- [ ] feat: after generating the question, the host UI should render the incoming question first and have a separate button to fire that tentative question out to the participants. The display should be a distinct div from the one in which we manually edit. 
