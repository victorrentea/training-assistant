...
def run() -> None:
    ...
    # Send session folders list when backend requests it (only on backend start)
    def _on_request_session_folders(_data):
    ...
    ws_client.register_handler("request_session_folders", _on_request_session_folders)
