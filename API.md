...
| Endpoint | Request | Response |
| --- | --- | --- |
| Resolve Participant Locations, backfill city name + timezone + country<br>for participants whose location is still raw lat/lon.<br>`POST /api/{session_id}/host/participants/resolve-locations` | - | - |
