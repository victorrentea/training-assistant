...
| Poll generation progress update<br>`poll_status` | `status: string  # "generating"\|"ready"\|"error"`<br>`message: string` |
| Poll preview for host review before publishing (poll=null to clear)<br>`poll_preview` | `poll?: any  # Set to null to clear the preview`<br>`question?: string`<br>`options?: list[string]`<br>`multi?: bool`<br>`correct_indices?: list[int]` |
...
| Host clears the current poll preview.<br>`DELETE /api/{session_id}/host/poll-preview` | - | - |
| Clear Queue<br>`DELETE /api/{session_id}/host/poll-queue` | - | `ok?: bool` |
| Get Queue Status, return how many questions are pending and what the current question looks like.<br>`GET /api/{session_id}/host/poll-queue` | - | `pending: int`<br>`current?: PollQueueQuestion{`<br>&nbsp;&nbsp;&nbsp;&nbsp;`question:string`<br>&nbsp;&nbsp;&nbsp;&nbsp;`options:list[PollQueueOption{`<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;`id:string`<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;`text:string`<br>&nbsp;&nbsp;&nbsp;&nbsp;`}]`<br>&nbsp;&nbsp;&nbsp;&nbsp;`correct_ids:list[string]`<br>`}` |
| Submit Questions, replace the entire poll queue with the submitted questions.<br>`POST /api/{session_id}/host/poll-queue` | `questions: list[PollQueueQuestion{`<br>&nbsp;&nbsp;&nbsp;&nbsp;`question:string`<br>&nbsp;&nbsp;&nbsp;&nbsp;`options:list[PollQueueOption{`<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;`id:string`<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;`text:string`<br>&nbsp;&nbsp;&nbsp;&nbsp;`}]`<br>&nbsp;&nbsp;&nbsp;&nbsp;`correct_ids:list[string]`<br>`}]` | `ok?: bool` |
...
| Host requests regeneration of a specific question or option.<br>`POST /api/{session_id}/host/poll-refine` | `target: string`<br>`preview?: PollPreviewPayload-Input{`<br>&nbsp;&nbsp;&nbsp;&nbsp;`poll?:dict[str, any]`<br>&nbsp;&nbsp;&nbsp;&nbsp;`question?:string`<br>&nbsp;&nbsp;&nbsp;&nbsp;`options?:list[string]`<br>&nbsp;&nbsp;&nbsp;&nbsp;`multi?:bool`<br>&nbsp;&nbsp;&nbsp;&nbsp;`correct_indices?:list[int]`<br>`}` | - |
| Host requests a poll — stores request for the orchestrator loop to pick up.<br>`POST /api/{session_id}/host/poll-request` | `minutes?: int`<br>`topic?: string` | - |
...
| Set Poll Status, compatibility: {open: true} → open_poll, {open: false} → close_poll.<br>`PUT /api/{session_id}/host/poll/status` | `open: bool` | `OkResponse{`<br>&nbsp;&nbsp;&nbsp;&nbsp;`ok?:bool`<br>`} \| ClosePollResponse{`<br>&nbsp;&nbsp;&nbsp;&nbsp;`ok?:bool`<br>&nbsp;&nbsp;&nbsp;&nbsp;`vote_counts:dict[str, int]`<br>&nbsp;&nbsp;&nbsp;&nbsp;`total_votes:int`<br>`}` |
...
| Poll generation progress update<br>`poll_status` | `status: string  # "generating" \| "ready" \| "error"`<br>`message?: string` |
| Generated poll ready for host review (poll=null to clear)<br>`poll_preview` | `poll?: any  # Set to null to clear the preview`<br>`question?: string`<br>`options?: list[object]`<br>`multi?: bool`<br>`correct_indices?: list[int]` |
