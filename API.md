...
| Talk Presentation Path, host drops a PPTX file during a talk<br>— log its path and Google Drive URL.<br>`POST /api/session/talk-presentation-path` | `path: string` | - |
