...
| Get Poll State, return full poll state for host poll tab.<br>`GET /api/{session_id}/host/poll` | - | `poll?: HostPollData{`<br>&nbsp;&nbsp;&nbsp;&nbsp;`id:string`<br>&nbsp;&nbsp;&nbsp;&nbsp;`question:string`<br>&nbsp;&nbsp;&nbsp;&nbsp;`options:list[string]`<br>&nbsp;&nbsp;&nbsp;&nbsp;`multi:bool`<br>&nbsp;&nbsp;&nbsp;&nbsp;`correct_count?:int`<br>&nbsp;&nbsp;&nbsp;&nbsp;`timer_seconds?:int`<br>&nbsp;&nbsp;&nbsp;&nbsp;`timer_started_at?:string`<br>&nbsp;&nbsp;&nbsp;&nbsp;`correct_indices?:list[int]`<br>`}`<br>`poll_active: bool`<br>`vote_counts: list[int]`<br>`votes: dict[str, HostPollVote{`<br>&nbsp;&nbsp;&nbsp;&nbsp;`option_indices:list[int]`<br>&nbsp;&nbsp;&nbsp;&nbsp;`voted_at:string`<br>`}]` |
