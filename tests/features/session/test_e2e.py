...
class TestLandingPage:
    ...
    def test_host_landing_layout_when_no_active_session(self, server_url, playwright):
        ...
        expect(page.locator(".new-session-label")).to_have_text("NEW WORKSHOP", timeout=5000)
        expect(page.locator(".folders-header")).to_have_text("RESUME WORKSHOP", timeout=5000)
