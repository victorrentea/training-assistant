"""
Hermetic E2E test: Quiz voting, results display, and scoring.

Verifies:
1. Participants can vote in quizzes and see correct results
...
@pytest.mark.nightly
def test_quiz_vote_results_and_scoring():
    """Full quiz flow: create → vote → close → reveal correct → verify scores."""
    session_id = fresh_session("QuizScoring")
    ...
    with sync_playwright() as p:
        ...
        # ── Step 1: Host creates and opens quiz ──
        host.create_quiz("What is 2+2?", ["3", "4", "5"])
        print("Step 1 OK: Quiz created and opened")
        ...
        # ── Step 3: Host closes quiz ──
        host.close_quiz()
        print("Step 3 OK: Quiz closed")
        ...
        print("SUCCESS: Quiz voting, results, and scoring all work correctly!")
        browser.close()
